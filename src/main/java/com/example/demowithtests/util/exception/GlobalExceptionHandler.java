...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> NoSuchPassportException(NoSuchPassportException exception,
                                                     WebRequest request) {
    ...
    public ResponseEntity<?> CountryDoesNotMatchAddressesException(
            CountryDoesNotMatchAddressesException exception,
            WebRequest request) {
        ErrorDetails errorDetails = new ErrorDetails(new Date(),
                exception.getMessage(),
                request.getDescription(false));
    ...
    public ResponseEntity<?> ResourceMarkedAsDeletedException(
            ResourceMarkedAsDeletedException exception,
            WebRequest request) {
        ErrorDetails errorDetails = new ErrorDetails(new Date(),
                exception.getMessage(),
                request.getDescription(false));
    ...
    public ResponseEntity<?> noSuchEmployeeException(NoSuchEmployeeException exception,
                                                     WebRequest request) {
        ErrorDetails errorDetails = new ErrorDetails(new Date(),
                exception.getMessage(),
                request.getDescription(false));
    ...
    public ResponseEntity<?> resourceIsPrivateException(ResourceIsPrivateException exception,
                                                        WebRequest request) {
        ErrorDetails errorDetails = new ErrorDetails(new Date(),
                "Resource is private",
                //                exception.getMessage(),
