...
public interface PassportControllerApiDoc extends PassportController {

    @Override
    @Operation(summary = "This is endpoint to return passport by id.",
            description = "Create request to read passport by id", tags = {"Passport"})
    @ApiResponses(
            value = {
                    @ApiResponse(responseCode = "200", description = "OK. Passport has been found"),
                    @ApiResponse(responseCode = "204",
                            description = "NO CONTENT. Passport hasn't been found"),
                    @ApiResponse(responseCode = "400", description = "BAD REQUEST. Invalid input"),
                    @ApiResponse(responseCode = "401",
                            description = "UNAUTHORIZED. Authentication is needed"),
                    @ApiResponse(responseCode = "403", description = "FORBIDDEN. Access denied"),
                    @ApiResponse(responseCode = "404",
                            description = "NOT FOUND. Resource was not found")})
    PassportReadDto getPassport(@PathVariable Integer id);


    @Override
    @Operation(summary = "This is endpoint to add a new passport.",
            description = "Create request to add a new passport.", tags = {"Passport"})
    @ApiResponses(
            value = {
                    @ApiResponse(responseCode = "201", description = "CREATED. Passport was added"),
                    @ApiResponse(responseCode = "400", description = "BAD REQUEST. Invalid input"),
                    @ApiResponse(responseCode = "401",
                            description = "UNAUTHORIZED. Authentication is needed"),
                    @ApiResponse(responseCode = "403", description = "FORBIDDEN. Access denied"),
...
//    @Override
//    @Operation(summary = "This is endpoint to update employee.",
//            description = "Create request to update employee.",
//            tags = {"Employee"})
//    @ApiResponses(
//            value = {@ApiResponse(responseCode = "200",
//                    description = "OK. Employee has been updated"),
//                    @ApiResponse(responseCode = "204",
//                            description = "NO CONTENT. Employee hasn't been found"),
//                    @ApiResponse(responseCode = "400", description = "BAD REQUEST. Invalid input"),
//                    @ApiResponse(responseCode = "401",
//                            description = "UNAUTHORIZED. Authentication is needed"),
//                    @ApiResponse(responseCode = "403", description = "FORBIDDEN. Access denied"),
...
//    @ApiResponses(value = {
//            @ApiResponse(responseCode = "200", description = "OK. Employee has been updated"),
//            @ApiResponse(responseCode = "204",
//                    description = "NO CONTENT. Employee hasn't been found"),
//            @ApiResponse(responseCode = "400", description = "BAD REQUEST. Invalid input"),
//            @ApiResponse(responseCode = "401",
...
//            description = "OK. Employee has been marked as deleted"),
//            @ApiResponse(responseCode = "204",
//                    description = "NO CONTENT. Employee hasn't been found"),
//            @ApiResponse(responseCode = "400", description = "BAD REQUEST. Invalid input"),
//            @ApiResponse(responseCode = "401",
...
//
//    @Override
//    @Operation(summary = "This is endpoint to delete employee.",
//            description = "Create request to delete employee.",
//            tags = {"Employee"})
//    @ApiResponses(
//            value = {@ApiResponse(responseCode = "200",
//                    description = "OK. Employee has been deleted"),
//                    @ApiResponse(responseCode = "204",
//                            description = "NO CONTENT. Employee hasn't been found"),
//                    @ApiResponse(responseCode = "400", description = "BAD REQUEST. Invalid input"),
//                    @ApiResponse(responseCode = "401",
...
//    @ApiResponses(value = {
//            @ApiResponse(responseCode = "200", description = "OK. Employees have been gotten"),
...
//    @ApiResponses(value = {
//            @ApiResponse(responseCode = "200", description = "OK. Employees have been deleted"),
...
//            description = "Create request to get page of employees by country.",
//            tags = {"Employee"})
//    @ApiResponses(value = {
//            @ApiResponse(responseCode = "200", description = "OK. Employees have been gotten"),
//            @ApiResponse(responseCode = "204",
//                    description = "NO CONTENT. There are no such employees"),
//            @ApiResponse(responseCode = "400", description = "BAD REQUEST. Invalid input"),
//            @ApiResponse(responseCode = "401",
//                    description = "UNAUTHORIZED. Authentication is needed"),
//            @ApiResponse(responseCode = "403", description = "FORBIDDEN. Access denied"),
//            @ApiResponse(responseCode = "404", description = "NOT FOUND. Resource was not found")})
//    Page<EmployeeReadDto> getEmployeesByCountry(String country, int page, int size,
...
//            description = "Create request to get list of all employees' countries.",
//            tags = {"Employee"})
//    @ApiResponses(value = {
//            @ApiResponse(responseCode = "200", description = "OK. Countries list have been gotten"),
...
//    @Override
//    @Operation(
//            summary = "This is an endpoint to return a  sorted list of all employees' countries.",
//            description = "Create request to get sorted list of all employees' countries.",
//            tags = {"Employee"})
//    @ApiResponses(value = {
//            @ApiResponse(responseCode = "200", description = "OK. Countries list have been gotten"),
//            @ApiResponse(responseCode = "204", description = "NO CONTENT. No countries found"),
...
//            description = "Create request to get list of all employees' emails.",
//            tags = {"Employee"})
//    @ApiResponses(value = {
//            @ApiResponse(responseCode = "200", description = "OK.  Emails list have been gotten"),
...
//            description = "Create request to get employees by gender and country.",
//            tags = {"Employee"})
//    @ApiResponses(value = {
//            @ApiResponse(responseCode = "200", description = "OK. Employees have been gotten"),
//            @ApiResponse(responseCode = "204",
...
//    @Override
//    @Operation(
//            summary = "This is endpoint to return page of employees who have active addresses in a given country.",
...
//            @ApiResponse(responseCode = "403", description = "FORBIDDEN. Access denied"),
//            @ApiResponse(responseCode = "404", description = "NOT FOUND. Resource was not found")})
//    Page<EmployeeReadDto> getEmployeesWithActiveAddressesInCountry(String country, int page,
//                                                                   int size);
//
//
//    @Override
//    @Operation(summary =
//            "Endpoint is used to set value of field IsDeleted=FALSE for all employees whose field " +
//                    "IsDeleted=NULL.",
//            description = "Create request to setup IsDeleted=FALSE for all employees whose field IsDeleted=NULL.",
//            tags = {"Employee"})
//    @ApiResponses(value = {@ApiResponse(responseCode = "200",
//            description = "OK. Request was handled successfully"),
...
//    @Override
//    @Operation(summary =
//            "Endpoint is used to set value of field IsPrivate=FALSE for all employees whose field " +
//                    "IsPrivate=NULL.",
...
//    @Override
//    @Operation(summary =
//            "Endpoint is used to set value of field IsConfirmed=FALSE for all employees whose field " +
//                    "IsConfirmed=NULL.",
//            description = "Create request to setup IsPrivate=FALSE for all employees whose field IsPrivate=NULL.",
//            tags = {"Employee"})
//    @ApiResponses(value = {@ApiResponse(responseCode = "200",
...
//            @ApiResponse(responseCode = "200", description = "OK. Employees have been gotten"),
//            @ApiResponse(responseCode = "204",
//                    description = "NO CONTENT.There are no active employees"),
//            @ApiResponse(responseCode = "400", description = "BAD REQUEST. Invalid input"),
//            @ApiResponse(responseCode = "401",
//                    description = "UNAUTHORIZED. Authentication is needed"),
//            @ApiResponse(responseCode = "403", description = "FORBIDDEN. Access denied"),
...
//    @Override
//    @Operation(
//            summary = "Endpoint is used to send email to employee with a request to confirm their data.",
//            description = "Create request to send email to employee with a request to confirm the data.",
//            tags = {"Employee"})
//    @ApiResponses(
//            value = {@ApiResponse(responseCode = "200", description = "OK. Email have been sent"),
//                    @ApiResponse(responseCode = "204",
//                            description = "NO CONTENT. No users to process"),
//                    @ApiResponse(responseCode = "400", description = "BAD REQUEST. Invalid input"),
//                    @ApiResponse(responseCode = "401",
//                            description = "UNAUTHORIZED. Authentication is needed"),
//                    @ApiResponse(responseCode = "403", description = "FORBIDDEN. Access denied"),
...
//            description = "Create request to set value of field isConfirmed=TRUE for employee.",
//            tags = {"Employee"})
//    @ApiResponses(
//            value = {@ApiResponse(responseCode = "200", description = "OK. Employee is confirmed"),
//                    @ApiResponse(responseCode = "204",
//                            description = "NO CONTENT. Employee hasn't been found"),
//                    @ApiResponse(responseCode = "400", description = "BAD REQUEST. Invalid input"),
//                    @ApiResponse(responseCode = "401",
...
//    @ApiResponses(
//            value = {@ApiResponse(responseCode = "200", description = "OK. Employees were created"),
//                    @ApiResponse(responseCode = "400", description = "BAD REQUEST. Invalid input"),
//                    @ApiResponse(responseCode = "401",
//                            description = "UNAUTHORIZED. Authentication is needed"),
//                    @ApiResponse(responseCode = "403", description = "FORBIDDEN. Access denied"),
...
//    @ApiResponses(
//            value = {@ApiResponse(responseCode = "200", description = "OK. Employees were updated"),
//                    @ApiResponse(responseCode = "204",
...
//    @Override
//    @Operation(
//            summary = "Endpoint is used to send a notification email to employees whose photos are expired.",
//            description = "Create request to send a notification email to employees whose photos are expired.",
//            tags = {"Employee"})
//    @ApiResponses(
//            value = {@ApiResponse(responseCode = "200", description = "OK. Emails have been sent"),
//                    @ApiResponse(responseCode = "204",
//                            description = "NO CONTENT. There are no such employees"),
//                    @ApiResponse(responseCode = "400", description = "BAD REQUEST. Invalid input"),
//                    @ApiResponse(responseCode = "401",
...
//    @ApiResponses(value = {
//            @ApiResponse(responseCode = "200", description = "OK. Active photo has been found"),
//            @ApiResponse(responseCode = "204",
//                    description = "NO CONTENT. Employee hasn't been found"),
//            @ApiResponse(responseCode = "400", description = "BAD REQUEST. Invalid input"),
//            @ApiResponse(responseCode = "401",
...
//            description = "Create request to get image of active photo of employee",
//            tags = {"Photo"})
//    @ApiResponses(value = {
//            @ApiResponse(responseCode = "200", description = "OK. Active photo has been found"),
//            @ApiResponse(responseCode = "204",
